...
class Excel2Map:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Excel 2 Map')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Excel2Map', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/excel2map/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Excel a Mapa'),
            callback=self.run,
